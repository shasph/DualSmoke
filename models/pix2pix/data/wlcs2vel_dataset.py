...
class Wlcs2velDataset(BaseDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        # parser.set_defaults(display_id=-1)  # specify dataset-specific default values
        return parser
    ...
    def __init__(self, opt):
        ...
        self.image_paths = self._get_image_paths(opt)
        # self._check_dataset()
    ...
    def _get_image_paths(self, opt):
        img_paths = []
        for i in glob.glob(self.dir_AB + '/*'):
            image = i + '/heatmap.png'
