...
class Skeleton2lcsDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        B_paths = f'{img_path}'
        data_A = transforms.Compose([transforms.ToTensor()])(label)    # needs to be a tensor
        data_B = transforms.Compose([transforms.ToTensor()])(img)   # needs to be a tensor
